  ...
  head: () => ({
    meta: [
      { title: "Dashboard · TeacherOS" },
      {
        name: "description",
        content:
          "Your daily execution system: today's classes, pending workflows, AI briefing, and at-risk students.",
      },
    ],
  }),
          ...
          <div className="flex items-center justify-between p-5 border-b border-border">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Tap a class to start the lesson workflow.
              </p>
            </div>
            <Link to="/teaching" className="text-xs text-primary font-medium hover:underline">
              View week →
            </Link>
          </div>
        ...
        <div className="rounded-xl border border-primary/30 bg-gradient-to-br from-primary-soft to-card p-5">
          ...
          <ul className="mt-4 space-y-3 text-sm">
            ...
            <li className="flex gap-2">
              ...
              <span>
                <strong>2 students</strong> in Sampaguita dropped &gt;5% in Quarter 1. Suggested
                interventions ready.
              </span>
            </li>
            <li className="flex gap-2">
              ...
              <span>
                SF2 for September is <strong>92% auto-filled</strong>. 3 attendance entries need
                confirmation.
              </span>
            </li>
            <li className="flex gap-2">
            ...
            <div>
              ...
              <div className="mt-1 flex items-baseline gap-2">
                <span className="text-3xl font-display font-semibold">
                  87<span className="text-base text-muted-foreground">.2</span>
                </span>
      ...
      <div className="rounded-xl border border-border bg-card">
        <div className="flex items-center justify-between p-5 border-b border-border">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Predicted by Student Risk Analyst agent.
            </p>
          </div>
          <Link to="/students" className="text-xs text-primary font-medium hover:underline">
            Open hub →
          </Link>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 p-4">
          {atRiskStudents.map((s) => (
            <div
              key={s.id}
              className="flex items-center gap-3 p-3 rounded-lg border border-border hover:border-destructive/50 transition-colors"
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-muted-foreground">
                  Avg {s.averageGrade} · Att {s.attendance}%
                </div>
              </div>
