...
export const aiAgents = [
  { id: "lesson", name: "Lesson Planning Agent", desc: "Drafts DLLs aligned to MELC.", color: "bg-info/10 text-info", icon: "BookOpen" as const },
  { id: "assessment", name: "Assessment Agent", desc: "Generates quizzes & rubrics.", color: "bg-success/10 text-success", icon: "ClipboardCheck" as const },
  { id: "grade", name: "Grade Computation Agent", desc: "Computes DepEd-weighted grades.", color: "bg-warning/10 text-warning", icon: "Calculator" as const },
  { id: "forms", name: "Forms Agent", desc: "Fills SF1–SF10 with validation.", color: "bg-primary/10 text-primary", icon: "FileText" as const },
  { id: "report", name: "Report Writing Agent", desc: "Writes RPMS & narrative reports.", color: "bg-accent text-accent-foreground", icon: "FileSignature" as const },
  { id: "risk", name: "Student Risk Analyst", desc: "Predicts at-risk learners.", color: "bg-destructive/10 text-destructive", icon: "AlertTriangle" as const },
];
...
export const mockParentLogs: ParentCommsLog[] = [
  { id: "l1", studentId: "s-1", date: "2026-09-20", channel: "SMS", message: "Reminder: Parent meeting Friday 3PM", status: "sent" },
  { id: "l2", studentId: "s-1", date: "2026-09-15", channel: "Messenger", message: "Grade update — Science quiz result: 85%", status: "sent" },
  { id: "l3", studentId: "s-1", date: "2026-09-10", channel: "Letter", message: "Regarding Juan's behavior in class", status: "sent" },
  { id: "l4", studentId: "s-3", date: "2026-09-22", channel: "SMS", message: "Absence notification for Mario Reyes", status: "sent" },
  { id: "l5", studentId: "s-1", date: "2026-09-25", channel: "Messenger", message: "Conference scheduled for Oct 1", status: "draft" },
];

// Teaching schedule (weekly)
export const mockTeachingWeek: TeachingDay[] = [
  {
    date: "2026-06-07", dayName: "Monday",
    classes: [
      { id: "m1", time: "7:30–8:20", subject: "Math 6", section: "Sampaguita", status: "completed", dllLinked: true, attendanceCaptured: true, reflectionDone: true },
      { id: "m2", time: "8:20–9:10", subject: "Science 6", section: "Rosal", status: "completed", dllLinked: true, attendanceCaptured: true, reflectionDone: false },
      { id: "m3", time: "9:30–10:20", subject: "English 6", section: "Ilang-Ilang", status: "completed", dllLinked: false, attendanceCaptured: true, reflectionDone: false },
    ],
  },
  {
    date: "2026-06-08", dayName: "Tuesday",
    classes: [
      { id: "t1", time: "7:30–8:20", subject: "Math 6", section: "Sampaguita", status: "completed", dllLinked: true, attendanceCaptured: true, reflectionDone: true },
      { id: "t2", time: "10:20–11:10", subject: "AP 6", section: "Sampaguita", status: "completed", dllLinked: false, attendanceCaptured: false, reflectionDone: false },
    ],
  },
  {
    date: "2026-06-09", dayName: "Wednesday",
    classes: [
      { id: "w1", time: "7:30–8:20", subject: "Math 6", section: "Sampaguita", status: "in-progress", dllLinked: false, attendanceCaptured: false, reflectionDone: false },
  ...
  {
    date: "2026-06-10", dayName: "Thursday",
    classes: [
  ...
  {
    date: "2026-06-11", dayName: "Friday",
    classes: [
...
export const mockReportTemplates = [
  ...
  { id: "r2", name: "Monthly Accomplishment — September", type: "Monthly", status: "in-progress", lastEdited: "Yesterday" },
  { id: "r3", name: "Narrative Report — Science Fair", type: "Narrative", status: "completed", lastEdited: "Sep 25" },
  { id: "r4", name: "Quarterly Assessment Analysis", type: "Narrative", status: "draft", lastEdited: "Sep 20" },
];